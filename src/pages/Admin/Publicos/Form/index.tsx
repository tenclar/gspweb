...
const FormPublicos: React.FC = () => {
  ...
  const handleSubmit = useCallback(
    async (data: PublicosFormData) => {
      try {
        ...
        history.push('/ad/cadastro/publicos');
      } catch (err) {
        ...
        addToast({
          ...
          description: 'Ocorreu um erro ao fazer Cadastro de Publicos.',
        });
      }
    },
  ...
  return (
    <Container>
      <Title>
        <h1>Formulário de {id ? 'Cadastro' : 'Alteração'} de Publicos</h1>
        <hr />
      </Title>
      <Panel>
        <Form
        ...
        >
          ...
          <div>
            ...
            <LinkButton to="/ad/cadastro/publicos">Cancelar</LinkButton>
          </div>
        </Form>
      </Panel>
    </Container>
